...
def build_jobs_view(page: ft.Page, state: AppState) -> ft.View:
    ...
    def open_import_dialog(_: ft.ControlEvent) -> None:
        ...
        help_text = (
            ...
            "  • model:    seedance_2_5 | seedance_2 | kling_3_0_pro | kling_3_0_4k |\n"
            "              kling_o3_4k | happyhorse_1_0\n"
            "  • duration: 3 … 15  (model-dependent)\n"
            "  • aspect:   16:9 | 9:16 | 1:1 | 21:9 | 3:4 | 4:3  (model-dependent)\n"
            "  • audio:    true | false\n"
